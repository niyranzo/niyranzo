...
I enjoy building web applications that combine a clean user experience
with well-structured frontend and backend architectures.

My experience includes developing **Full Stack applications, REST APIs,
database integrations and web solutions** using technologies such as
React, Node.js, Angular, PostgreSQL and MongoDB.
